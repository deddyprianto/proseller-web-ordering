const styles = {
  "@global": {
      ...
      ".section-recent-posts .section-title, .terms-conditions .entry-content .section.contact-us p a": { color: "#7c0619" },
      ...
      ".pizzaro-order-steps ul .step": { borderColor: (e) => e.theme.color.primary },
      ...
      '#respond input[type="submit"]:hover': { backgroundColor: "#86071b" },
      "@media (max-width: 1025px)": { ".page-template-template-homepage-v5 .header-v5": { backgroundColor: (e) => e.theme.color.primary } },
      ".modal-dialog-centered": { display: "flex", fallbacks: [{ display: "-ms-flexbox" }], msFlexAlign: "center", alignItems: "center", minHeight: "calc(80% - 1rem)" },
      ".modal-title": { color: (e) => e.theme.color.primary },
      "button.close.btn-close-modal-product": { backgroundColor: (e) => e.theme.color.primary },
      ".use-select": { backgroundColor: (e) => e.theme.color.primary, width: "50%", fontSize: "12", height: "40", borderRadius: "0" },
      ".un-select": { backgroundColor: "#beb9ba", width: "50%", fontSize: "12", height: "40", borderRadius: "0" },
      ".border-ordering-mode": { borderColor: (e) => e.theme.color.secondary, borderStyle: "solid", borderWidth: "thin" },
      ".border-theme": { borderColor: (e) => e.theme.color.primary, borderWidth: "1", borderStyle: "solid", color: (e) => e.theme.color.primary },
      ".profile-dashboard, .select-gender": { backgroundColor: (e) => e.theme.color.primary, color: (e) => e.theme.color.textButtonColor, },
      ".navigation-theme": { backgroundColor: (e) => e.theme.color.navigation },
      ".un-select-gender": { backgroundColor: "#beb9ba" },
      ...
      ".text-btn-theme, button, .button": { color: (e) => e.theme.color.textButtonColor, borderRadius: 5, padding: 0, },
