...
class DetailProfile extends Component {
  ...
  componentDidMount = async () => {
    ...
    if (response.ResultCode === 200) this.setState({ referall: `${response.Data.amount}/${response.Data.capacity}` })
  ...
  viewLeftPage = (loadingShow) => {
    ...
    if (account.defaultImageURL === undefined) account.defaultImageURL = profile;
        ...
        }
        {
          ...
          <div>
            <div className="profile-dashboard" style={{
              ...
              textAlign: "center", boxShadow: "1px 2px 5px rgba(128, 128, 128, 0.5)",
              display: "flex", flexDirection: "column", alignItems: "center"
            }}>
              <div data-toggle="modal" data-target="#qrcode-modal" style={{
                position: "absolute", left: 15, top: 19, backgroundColor: "#FFF", padding: 5, borderBottomRightRadius: 5,
                cursor: "pointer", borderTopRightRadius: 5
              }}>
                <img src={QRCodeLogo} alt="qrcode" style={{ height: 40, width: 40 }} />
              </div>
              <div style={{ width: 100 }}>
                <img src={account.defaultImageURL} alt="Profile" style={{
                  height: 100, width: 100, borderRadius: 5, boxShadow: "1px 2px 5px rgba(128, 128, 128, 0.5)", objectFit: "cover"
                }} />
              </div>
              <div style={{ color: "#FFF", fontWeight: "bold", fontSize: 16, marginTop: 10 }}>
                {account.name}
              </div>
              <div style={{ color: "#FFF" }}>
                {account.phoneNumber}
            ...
            <div style={{
              backgroundColor: "#FFF", padding: 10, marginTop: -15,
              borderTopLeftRadius: 20, borderTopRightRadius: 20, border: "1px solid #CDCDCD",
              ...
              <div style={{ textAlign: "center" }} >
                ...
                <div className="customer-group-name" style={{ fontSize: 30, fontWeight: "bold", paddingBottom: 10 }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-around" }} >
                <div style={{ color: "gray", fontSize: 16, fontWeight: "bold", width: "50%", }}
        ...
        }
        {
          ...
          <div>
            ...
            <div className="profile-dashboard"
              onClick={() => this.handleLogout()} style={{
