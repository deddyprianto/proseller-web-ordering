              ...
              <Button
                ...
                onClick={() =>
                  localStorage.setItem(
                    `${config.prefix}_getPaymentMethod`,
                    true
                  )
                }
                style={{
                  ...
                  flexDirection: "row",
                  alignItems: "center",
                  fontSize: props.selectedCard === null ? 12 : 10,
                }}
              >
                <CreditCard style={{ fontSize: 16 }} />
                {props.selectedCard === null
                  ? "Select Methods"
                  : props.selectedCard.details.cardIssuer
                  ? props.selectedCard.details.cardIssuer.toUpperCase() +
                    " " +
                    props.selectedCard.details.maskedAccountNumber.substr(
                      props.selectedCard.details.maskedAccountNumber.toString()
                        .length - 4
                    )
                  : "- " +
                    props.selectedCard.details.maskedAccountNumber.substr(
