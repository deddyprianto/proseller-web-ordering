  ...
  render() {
    ...
    return (
      <div style={{ border: "1px solid #DCDCDC", borderRadius: 5, marginTop: 10, padding: 10 }}>
        {<ModalOrderingMode data={props} setOrderingMode={(mode) => this.props.setOrderingMode(mode)} />}
        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
          <div style={{ fontWeight: "bold", color: "gray", fontSize: 14 }}>Ordering Mode</div>
          <Button disabled={this.props.roleDisableNotPending} id="ordering-mode-basket-btn"
            data-toggle="modal" data-target="#ordering-mode-basket-modal"
            style={{
